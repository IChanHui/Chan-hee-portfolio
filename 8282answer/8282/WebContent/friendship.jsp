	...
	<div class="container">
		<div class="row">
			...
			<%
				if(pageNumber != 1) {
			%>
				<a href="friendship.jsp?pageNumber=<%=pageNumber - 1 %>" class="btn btn-sucess btn-arraw-left">이전</a>
			<%
				} if (bbsDAO.nextPage(pageNumber+1)) {
			%>	
				<a href="friendship.jsp?pageNumber=<%=pageNumber + 1 %>" class="btn btn-sucess btn-arraw-left">다음</a>
			<%
				}
			%>
